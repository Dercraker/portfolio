...
export const TestimonialSection = () => {
  return (
    <SectionLayout className="relative mx-auto w-full max-w-7xl overflow-hidden px-4 pt-20 md:px-8">
      <div className="pb-20">
        <h1 className="pt-4 text-lg font-bold text-black dark:text-white md:text-2xl">
      ...
      <div className=" relative">
        <div className="bg-charcoal w-full overflow-hidden">
          <TestimonialsGrid />
        </div>
      </div>
