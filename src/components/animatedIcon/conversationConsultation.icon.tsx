...
import ICON from "@assets/wired-outline-981-consultation-hover-conversation.json";
...
type ConversationConsultationIconProps = {
  onClick?: () => void;
...
export const ConversationConsultationIcon = ({
  ...
  stayLastFrame = false,
  onClick,
}: ConversationConsultationIconProps) => {
