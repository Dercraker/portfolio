...
const keyboardShortcutVariants = cva(
  "inline-flex items-center justify-center rounded border-y border-b-gray-200 border-t-white bg-accent px-1.5 font-sans text-[11px] text-gray-800 ring-1 ring-gray-300 dark:border-b-gray-950 dark:border-t-transparent dark:text-white dark:ring-white/15",
  {
    variants: {
      size: {
